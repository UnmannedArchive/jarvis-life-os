...
export default function CharacterStatus() {
  ...
  return (
    <HUDPanel delay={3} glow>
      <Link href="/goals" className="text-sm font-semibold text-text-secondary mb-4 uppercase tracking-wider block hover:text-text-primary transition-colors">Character</Link>
      <div className="flex items-center gap-3 mb-5">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-base font-semibold text-text-primary mb-1.5">Level {level}</div>
